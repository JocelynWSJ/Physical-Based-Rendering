#ifndef MICROFACETTRANSMISSIVEMATERIAL_H
#define MICROFACETTRANSMISSIVEMATERIAL_H
...
{
public:
    MicrofacetTransmissiveMaterial(const Color3f &Kt,
                  float indexOfRefraction, float roughness,
...
#endif // MICROFACETTRANSMISSIVEMATERIAL_H
