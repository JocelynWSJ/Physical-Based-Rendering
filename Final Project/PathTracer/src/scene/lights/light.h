...
class Light
{
  public:
    ...
    virtual float getProxyWattage() const = 0;
    virtual Color3f getEmittedLight() const = 0;
    virtual float getLightArea() const = 0;
    virtual void getSurfaceEmissionRay(const Point2f &xi, const Point2f& xk, Ray& ray, float& pdf) const = 0;
